...
OpenClaw 的爆火和去年 DeepSeek 的爆火高度类似——本质上都是**把一小撮人已经在享受的能力，第一次推到了更广泛的人群面前**。DeepSeek 让普通用户第一次用上了会搜索懂推理的 AI，OpenClaw 则让非技术人员第一次摸到了能读写文件、有记忆、会自我进化的 Agentic AI。具体来说，有三个关键的设计决策：

| 设计决策 | 为什么有效 | 带来的 trade-off |
|---------|-----------|-----------------|
| **聊天界面作为入口** | 复用 Slack/飞书/WhatsApp 等现有习惯，学习成本几乎为零，拿起手机就能用 | 线性对话、低信息密度、过程不可观测 |
| **统一上下文 + 持久化记忆** | 跨平台、跨会话记住你的一切，给人"它真的懂我"的感觉；heartbeat 自动维护记忆分层 | 记忆更新是黑盒，知识无法显式管理，跨项目容易信息污染 |
| **丰富的 Skills 生态** | 工具之间可组合，能力提升是超线性的；AI 还能自己写新 Skill，形成自我进化闭环 | 12% 第三方 Skill 含恶意代码，安全与好用成为一对矛盾 |

这三者之间还形成了**飞轮效应**：记忆 + 统一上下文带来数据复利，记忆 + Skills 带来自我进化，能力 + 易用性带来使用频率——越转越快，越用越强。

> 更完整的分析——包括如何把这些认知融入自己的工具链、扬长避短——详见[附录 B 第 9 节：深度分析](/cn/appendix/appendix-b#_9-深度分析-openclaw-为什么火-以及这跟我们有什么关系)。
