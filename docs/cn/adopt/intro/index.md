...
| 步骤 | 类比 | 你要做的 | 对应章节 |
|------|------|---------|---------|
| **租房子** | 给员工一个工位 | 安装 OpenClaw（本地电脑或云服务器） | [第一章](/cn/adopt/chapter1/) / [第二章](/cn/adopt/chapter2/) / [第十章](/cn/adopt/chapter10/) |
| **买粮食** | 给员工发工资 | 配置模型 API Key（Token 就是龙虾的"口粮"） | [第二章](/cn/adopt/chapter2/) / [第八章](/cn/adopt/chapter8/) |
| **给联系方式** | 让客户能找到员工 | 接入聊天平台（QQ / 飞书 / Telegram） | [第三章](/cn/adopt/chapter3/) / [第七章](/cn/adopt/chapter7/) |
| **培训上岗** | 教员工怎么干活 | 配置技能、记忆、个性化定制 | [第六章](/cn/adopt/chapter6/) / [第九章](/cn/adopt/chapter9/) |
...
**第一部分：领养 Claw**——使用篇，12 章（5 层难度梯度），从零基础到生产部署：

- **🔵 第一层：光速上手**（第 1 章）——下载 AutoClaw，5 分钟拥有 AI 助手，零门槛体验。
- **🟢 第二层：手动安装**（第 2～3 章）——手动安装 OpenClaw、接入聊天平台（QQ/飞书/Telegram），完全掌控配置和数据。
- **🟡 第三层：日常使用**（第 4～6 章）——命令行与配置、定时任务、技能系统入门，让龙虾真正为你干活。
- **🟠 第四层：高级配置**（第 7～9 章）——多平台与外部服务集成、多模型与成本优化、个性化定制（工作区与记忆系统）。
- **🔴 第五层：高级场景**（第 10～12 章）——生产环境部署、开发者效率提升、故障排查与维护。
